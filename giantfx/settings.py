"""
Django settings for giantfx project.
...
SECRET_KEY = 'django-insecure-#&cus16xo-wvm$wt7ovy$x5%(jmn#4x#f!ffztyal7bee+056@'
...
WSGI_APPLICATION = 'giantfx.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'giantfx' / 'static']
